...
interface Country {
  ...
  region: string;
  capital: string;
  states?: Array<{ name: string; population: number }>;
}
...
const Dashboard = () => {
  ...
  const [newState, setNewState] = useState<State>({ name: "", population: "" });
  ...
  const handleDeleteCountry = async (e: React.MouseEvent, id: number) => {
    e.stopPropagation();
          ...
          <div className="modal-overlay">
            <div className="modal">
              ...
              <div className="form-section">
                ...
                {(["name", "code", "population", "flag", "region", "capital"] as const).map((field) => (
                  <input
                    key={field}
